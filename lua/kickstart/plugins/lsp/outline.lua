...
return {
  ...
  keys = { -- Example mapping to toggle outline
    { '<leader>to', '<cmd>Outline<CR>', desc = 'Toggle code outline' },
  },
  opts = {
    outline_window = {
      position = 'left',
      ...
      hide_cursor = true, -- Hide cursor when not in focus, cursorline still shows
    },
    outline_items = {
      show_symbol_details = false, -- tooo verbose
    },
    preview_window = {
      border = 'single',
      winblend = 1,
...
--     vim.keymap.set('n', '<leader>xo', '<cmd>topleft Outline<CR>', { desc = 'Toggle [O]tline' })
--
